...
const githubJsonUrl = "https://raw.githubusercontent.com/tcrecruitment2025/tcprojects/main/notifications.json";
...
fetch(githubJsonUrl)
  ...
  .catch(error => {
    ...
    errorCard.innerHTML = `
      ...
      <h3>حدث خطأ أثناء تحميل الأخبار</h3>
